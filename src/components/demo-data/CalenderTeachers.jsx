...
export default function CalenderTeachers() {
  const [people, setPeople] = useState([
    { id: 1, name: 'Jane Doe' },
    { id: 2, name: 'Melisa Taylor' },
    { id: 3, name: 'sam' },
    { id: 4, name: 'John Doe' },
    { id: 5, name: 'Tanya Fox' },
      ...
      <Combobox id="Select Service" value={selected} onChange={setSelected}>
        <div className="relative">
          ...
          <Transition
            ...
            afterLeave={() => setQuery('')}
          >
            <Combobox.Options className="absolute mt-1 max-h-60 z-50 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
