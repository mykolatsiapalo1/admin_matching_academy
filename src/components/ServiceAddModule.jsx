...
export default function ServiceAddModule({ isOpen, setIsOpen }) {
  function closeModal() {
    setIsOpen(false)
  }
  return (
              ...
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden bg-white p-6 md:px-9 md:py-7 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-6">
                  <div className='space-y-4'>
                    <div>
                      <label htmlFor="first_name" className="font-medium">Service Name</label>
                      <input
                        type="text"
                        id="first_name"
                    ...
                    <div>
                      <label htmlFor="location" className="font-medium">Date & Time</label>
                      <input
                        type="date"
                        id="location"
                        className="outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                      <label htmlFor="reason" className="font-medium">Price</label>
                      <input
                        type="text"
                        id="reason"
                        className="outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                      <label htmlFor="reason" className="font-medium">Location</label>
                      <input
                        type="text"
                        id="reason"
                        className="outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                      <label htmlFor="reason" className="font-medium">Status</label>
                      <input
                        type="text"
                        id="reason"
                        className="outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
