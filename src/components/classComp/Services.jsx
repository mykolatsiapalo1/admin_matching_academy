...
export default function Services({ people, selectedService, setSelectedService, setServiceId }) {
  ...
  return (
    <div>
      <label htmlFor="Select Service" className="block mb-2 text-base font-semibold text-gray-900 dark:text-white">Select Service</label>
      ...
      <Combobox id="Select Service" value={selectedService} onChange={e => { setSelectedService(e.serviceName); setServiceId(e.id); }}>
                ...
                filteredPeople.map((person) => (
                  ...
                  >
                    {({ selectedService, active }) => (
                      <>
                        <span
                          className={`block truncate ${selectedService ? 'font-medium' : 'font-normal'
                            }`}
                        >
                          {person.serviceName}
                        </span>
