...
export default function Status({ selected, setSelected }) {
  ...
  return (
    <div>
      <label htmlFor="Select Service" className="block mb-2 text-base font-semibold text-gray-900 dark:text-white">Select Status</label>
      ...
      <Combobox id="Select Service" value={selected} onChange={e => { setSelected(e.name); console.log(e) }}>
