...
export default function Students({ selected, setSelected, people, query, setQuery, setStudentId }) {
  ...
  return (
    <div>
      ...
      <Combobox id="Select Service" value={selected} onChange={e => { setSelected(`${e.firstName} ${e.lastName}`); setStudentId(e) }}>
